...
<h3>회원정보 수정</h3>
	...
	<input type="hidden" name="rno" value="${edit.rno}">
		<p>아이디 : ${edit.rid}
		<p>비밀번호 : <input type="password" name="rpasswd" required value="${edit.rpasswd}">
		<p>이름 : <input type="text" name="rname" required value="${edit.rname}">
	...
	- <input type="text" name="rtel2" size="4" required value="${edit.rtel.substring(4,8)}">
	- <input type="text" name="rtel3" size="4" required value="${edit.rtel.substring(9)}">
